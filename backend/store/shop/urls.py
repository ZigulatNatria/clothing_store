...
from .views import category_product_list_view, ProductDetail, product_categories, ClothingCategoriesView
...
urlpatterns =[
    ...
    path('categories_global/', ClothingCategoriesView.as_view(), name='categories_global'),
]